...
const STANDS = [
  {
    ...
    description: "Présentation des solutions et projets développés par E GARAME.",
  ...
  },
  {
    ...
    description: "Découvrez l'univers BÖÖH et ses projets à l'intersection du numérique et du culturel.",
  ...
  {
    nom: "SIKUL GABON",
    tagline: "Mobilité & services numériques",
    description: "SIKUL GABON présente ses solutions de mobilité et services digitaux pour le Gabon.",
  ...
  {
    nom: "ALISSA IA",
    tagline: "Intelligence artificielle appliquée",
    description: "ALISSA IA développe des agents et outils d'IA adaptés aux besoins du marché africain.",
  ...
  },
  {
    ...
    description: "SAMBA TECH PRO accompagne les entreprises dans leur transformation numérique.",
  ...
  {
    nom: "DF.VISION",
    tagline: "Vision & stratégie digitale",
    description: "DF.VISION propose des approches innovantes pour la stratégie et la présence numérique.",
